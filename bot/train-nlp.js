...
// module.exports = async function trainnlp
export const trainnlp = async(manager) => {
  ...
  // const hrstart = process.hrtime(); // uncomment this line in case of issues
  // const hrstart = performance.now();
  
  // const hrend = process.hrtime(hrstart); // uncomment this line in case of errors
